...
export default function MemoryPage() {
  ...
  return (
    <div style={{ minHeight: '100dvh', background: 'var(--bg-deep)', color: 'var(--text-bright)', maxWidth: 480, margin: '0 auto', position: 'relative', fontFamily: 'inherit' }}>
      ...
      <div style={{ padding: 'calc(20px + env(safe-area-inset-top)) 16px 12px', borderBottom: '1px solid var(--border-soft)', position: 'sticky', top: 0, background: 'color-mix(in srgb, var(--bg-deep) 85%, transparent)', backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', zIndex: 10 }}>
