  ...
  return (
    <div style={shellStyle}>
      <div style={{
        ...
        background: PAPER, borderBottom: '1px solid rgba(184,160,100,0.28)',
      }}>
        <Link href="/closet" aria-label="回衣橱" style={{ color: GOLD, textDecoration: 'none', fontSize: '18px', lineHeight: 1 }}>‹</Link>
        <div style={{ fontSize: '10px', color: GOLD, fontStyle: 'italic', letterSpacing: '0.3em' }}>
          {isPick ? '· 选搭 ·' : '· 衣橱 ·'}
        </div>
        <button onClick={remove} aria-label="扔掉这一页" style={{
