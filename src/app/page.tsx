...
const ROOMS: { id: string; roman: string; en: string; cn: string; sub: string; href?: string }[] = [
  ...
  { id: 'health',   roman: 'II',   en: 'Health',     cn: '健康', sub: 'WELLBEING', href: '/health' },
  { id: 'memory',   roman: 'III',  en: 'Memory',     cn: '记忆', sub: 'REMEMBER', href: '/memory' },
  { id: 'calendar', roman: 'IV',   en: 'Calendar',   cn: '日历', sub: 'MILESTONES', href: '/calendar' },
  { id: 'music',    roman: 'V',    en: 'Music',      cn: '听歌', sub: 'DISC', href: '/music' },
  { id: 'box',      roman: 'VI',   en: 'Box',        cn: '铁盒', sub: 'KEEPSAKES', href: '/box' },
  { id: 'navi',     roman: 'VII',  en: 'Navi', cn: '导航', sub: 'PLACES', href: '/navi' },
  { id: 'call',     roman: 'VIII', en: 'Call',       cn: '通话', sub: 'VOICE', href: '/call' },
  { id: 'nearby',  roman: 'IX',   en: 'Nearby',    cn: '附近', sub: 'NEARBY', href: '/nearby' },
...
const HISAME_MINI_WINDOWS: HisameMiniRoom[] = [
  { id: 'seminar', href: '/seminar', label: 'Seminar', cn: '讲堂', glyph: '✦', meta: 'class room', tone: 'cream', tilt: '-0.6deg' },
  { id: 'health', href: '/health', label: 'Health', cn: '健康', glyph: '❀', meta: 'wellbeing', tone: 'mauve', tilt: '0.8deg' },
  { id: 'memory', href: '/memory', label: 'Memory', cn: '记忆', glyph: '†', meta: 'kept words', tone: 'cream', tilt: '-1deg' },
  { id: 'calendar', href: '/calendar', label: 'Calendar', cn: '日历', glyph: '✦', meta: 'milestones', tone: 'rose', tilt: '1.2deg' },
  { id: 'music', href: '/music', label: 'Music', cn: '听歌', glyph: '♪', meta: 'soft loop', tone: 'violet', tilt: '-0.5deg' },
  { id: 'box', href: '/box', label: 'Box', cn: '铁盒', glyph: '❀', meta: 'keepsakes', tone: 'mauve', tilt: '0.8deg' },
  { id: 'navi', href: '/navi', label: 'Navi', cn: '导航', glyph: '⌖', meta: 'places', tone: 'rose', tilt: '-1.3deg' },
  { id: 'call', href: '/call', label: 'Call', cn: '通话', glyph: '☎', meta: 'voice', tone: 'cream', tilt: '1.1deg' },
  { id: 'nearby', href: '/nearby', label: 'Nearby', cn: '附近', glyph: '♥', meta: 'nearby', tone: 'rose', tilt: '-0.8deg' },
  { id: 'backstage', href: '/backstage', label: 'Backstage', cn: '后台', glyph: '✧', meta: 'control', tone: 'violet', tilt: '0.6deg' },
];
...
function HomePortraitHubV2Legacy() {
  ...
  return (
    <section className="grace-home-hero grace-home-portrait-hub" aria-label="Portrait hub" style={portraitHubStyle}>
      <Link href="/chat" className="grace-home-hero-hitarea" aria-label="Enter Chats Hub">
    ...
    <main className="hisame-signal-home">
      <div className="hisame-signal-phone">
        ...
        <nav className="hisame-signal-room-grid" aria-label="Hisame Signal rooms">
          {[
            { id: 'messages', roman: '01', en: 'Messages', cn: '短信', sub: 'MAIN LINE', href: '/chat/messages' },
            { id: 'daily', roman: '02', en: 'Daily', cn: '日记', sub: 'TODAY PAGE', href: '/daily' },
            { id: 'tangents', roman: '03', en: 'Tangents', cn: '碎碎念', sub: 'SIDE THOUGHTS', href: '/tangents' },
            { id: 'deeptalk', roman: '04', en: 'DeepTalk', cn: '深谈', sub: 'QUIET ROOM', href: '/deeptalk' },
            { id: 'training', roman: '05', en: 'Training', cn: '调教室', sub: 'PRIVATE CLASS', href: '/training' },
            ...ROOMS.map((room, index) => ({
              ...room,
              roman: String(index + 6).padStart(2, '0'),
            })),
          ].map((room) => (
            <Link key={room.id} href={room.href || '/'} className="hisame-signal-room-card">
    ...
    <main className="v2-phone-frame">
      ...
      <div style={{ position: 'relative', zIndex: 1, flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{
          ...
          {ROOMS.map(r => (
            <Link key={r.id} className="v2-grid-card" href={r.href ?? `/${r.id}`}
